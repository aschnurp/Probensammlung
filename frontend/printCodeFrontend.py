...
def gather_code(root_folder, output_file):
    ...
    with open(output_file, 'w', encoding='utf-8') as all_code:
        ...
        app_folder = os.path.join(root_folder, 'frontend/src')
...
if __name__ == "__main__":
    ...
    output_file = 'allCodeFrontend.txt'  # Output file name

    gather_code(root_folder, output_file)
    print(f"FRONTEND!!!! Code from all .ts and .tsx files has been written to {output_file}")

export const getProbeOptions = (probenart) => {
  ...
  if (probenart === 'paraffin') {
    ...
    else if (probenart === 'galle') {
      differenzierungsmerkmalOptions = [
        { id: 1, text: "Zentrifugiert" },
        { id: 2, text: "nicht Zentrifugiert" },
      ];
  }
  ...
  const probeDataLTX = [
    ...
    {id: 13, text:"Galle post OP 7d von impl. Leber I", type:"galle"},
    {id: 14, text:"Galle post OP 7d von impl. Leber II", type:"galle"},
    {id: 15, text:"Galle post OP 7d von impl. Leber III", type:"galle"},
    {id: 16, text:"Galle post OP 7d von impl. Leber IV", type:"galle"},
    {id: 17, text:"Galle post OP 14d von impl. Leber I", type:"galle"},
    {id: 18, text:"Galle post OP 14d von impl. Leber II", type:"galle"},
    {id: 19, text:"Galle post OP 14d von impl. Leber III", type:"galle"},
    {id: 20, text:"Galle post OP 14d von impl. Leber IV", type:"galle"},
    {id: 21, text:"EDTA-Plasma bei Aufklährung I", type:"edtaplasma"},
    {id: 22, text:"EDTA-Plasma bei Aufklährung II", type:"edtaplasma"},
    {id: 23, text:"EDTA-Plasma bei Aufklährung III", type:"edtaplasma"},
    {id: 24, text:"EDTA-Plasma bei Aufklährung IV", type:"edtaplasma"},
    {id: 25, text:"EDTA-Plasma prä OP I", type:"edtaplasma"},
    {id: 26, text:"EDTA-Plasma prä OP II", type:"edtaplasma"},
    {id: 27, text:"EDTA-Plasma prä OP III", type:"edtaplasma"},
    {id: 28, text:"EDTA-Plasma prä OP IV", type:"edtaplasma"},
    ...
    {id: 33, text:"EDTA-Plasma post OP 1d I", type:"edtaplasma"},
    {id: 34, text:"EDTA-Plasma post OP 1d II", type:"edtaplasma"},
    {id: 35, text:"EDTA-Plasma post OP 1d III", type:"edtaplasma"},
    {id: 36, text:"EDTA-Plasma post OP 1d IV", type:"edtaplasma"},
    {id: 37, text:"EDTA-Plasma post OP 7d I", type:"edtaplasma"},
    {id: 38, text:"EDTA-Plasma post OP 7d II", type:"edtaplasma"},
    {id: 39, text:"EDTA-Plasma post OP 7d III", type:"edtaplasma"},
    {id: 40, text:"EDTA-Plasma post OP 7d IV", type:"edtaplasma"},
    {id: 41, text:"EDTA-Plasma post OP 14d I", type:"edtaplasma"},
    {id: 42, text:"EDTA-Plasma post OP 14d II", type:"edtaplasma"},
    {id: 43, text:"EDTA-Plasma post OP 14d III", type:"edtaplasma"},
    {id: 44, text:"EDTA-Plasma post OP 14d IV", type:"edtaplasma"},
    {id: 45, text:"EDTA-Plasma post OP 1 Jahr I", type:"edtaplasma"},
    {id: 46, text:"EDTA-Plasma post OP 1 Jahr II", type:"edtaplasma"},
    {id: 47, text:"EDTA-Plasma post OP 1 Jahr III", type:"edtaplasma"},
    {id: 48, text:"EDTA-Plasma post OP 1 Jahr IV", type:"edtaplasma"},
    ...
    {id: 53, text:"Stuhl post OP I", type:"stuhl"},
    {id: 54, text:"Stuhl post OP II", type:"stuhl"},
    {id: 55, text:"Stuhl post OP III", type:"stuhl"},
    {id: 56, text:"Stuhl post OP IV", type:"stuhl"},
    {id: 57, text:"Stuhl post OP 1 Jahr I", type:"stuhl"},
    {id: 58, text:"Stuhl post OP 1 Jahr II", type:"stuhl"},
    {id: 59, text:"Stuhl post OP 1 Jahr III", type:"stuhl"},
    {id: 60, text:"Stuhl post OP 1 Jahr IV", type:"stuhl"},
]

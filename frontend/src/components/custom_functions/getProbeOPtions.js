export const getProbeOptions = (probenart) => {
  ...
  const probeDataLTX = [
    ...
    { id: 30, text: "EDTA-Plasma intra OP I", type: "edtaplasma" },
    { id: 31, text: "EDTA-Plasma intra OP II", type: "edtaplasma" },
    { id: 32, text: "EDTA-Plasma intra OP III", type: "edtaplasma" },
    { id: 33, text: "EDTA-Plasma intra OP IV", type: "edtaplasma" },
    { id: 34, text: "EDTA-Plasma prä OP I", type: "edtaplasma" },
    { id: 35, text: "EDTA-Plasma prä OP II", type: "edtaplasma" },
    { id: 36, text: "EDTA-Plasma prä OP III", type: "edtaplasma" },
    { id: 37, text: "EDTA-Plasma prä OP IV", type: "edtaplasma" },
    { id: 38, text: "EDTA-Plasma post OP 1d I", type: "edtaplasma" },
    { id: 39, text: "EDTA-Plasma post OP 1d II", type: "edtaplasma" },
    { id: 40, text: "EDTA-Plasma post OP 1d III", type: "edtaplasma" },
    { id: 41, text: "EDTA-Plasma post OP 1d IV", type: "edtaplasma" },
    { id: 42, text: "EDTA-Plasma post OP 7d I", type: "edtaplasma" },
    { id: 43, text: "EDTA-Plasma post OP 7d II", type: "edtaplasma" },
    { id: 44, text: "EDTA-Plasma post OP 7d III", type: "edtaplasma" },
    { id: 45, text: "EDTA-Plasma post OP 7d IV", type: "edtaplasma" },
    { id: 46, text: "EDTA-Plasma post OP 14d I", type: "edtaplasma" },
    { id: 47, text: "EDTA-Plasma post OP 14d II", type: "edtaplasma" },
    { id: 48, text: "EDTA-Plasma post OP 14d III", type: "edtaplasma" },
    { id: 49, text: "EDTA-Plasma post OP 14d IV", type: "edtaplasma" },
    { id: 50, text:"Stuhl prä OP I", type:"stuhl"},
    { id: 51, text:"Stuhl prä OP II", type:"stuhl"},
    { id: 52, text:"Stuhl prä OP III", type:"stuhl"},
    { id: 53, text:"Stuhl prä OP IV", type:"stuhl"},
    { id: 54, text:"Stuhl post OP 1d I", type:"stuhl"},
    { id: 55, text:"Stuhl post OP 1d II", type:"stuhl"},
    { id: 56, text:"Stuhl post OP 1d III", type:"stuhl"},
    { id: 57, text:"Stuhl post OP 1d IV", type:"stuhl"},
    { id: 58, text:"Stuhl post OP 7d I", type:"stuhl"},
    { id: 59, text:"Stuhl post OP 7d II", type:"stuhl"},
    { id: 60, text:"Stuhl post OP 7d III", type:"stuhl"},
    { id: 61, text:"Stuhl post OP 7d IV", type:"stuhl"},
    { id: 62, text:"Stuhl post OP 14d I", type:"stuhl"},
    { id: 63, text:"Stuhl post OP 14d II", type:"stuhl"},
    { id: 64, text:"Stuhl post OP 14d III", type:"stuhl"},
    { id: 65, text:"Stuhl post OP 14d IV", type:"stuhl"},
]

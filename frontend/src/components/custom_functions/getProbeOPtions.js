export const getProbeOptions = (probenart) => {
  ...
  const probeDataLTX = [
    ...
    {id: 21, text:"EDTA-Plasma bei Aufklärung I", type:"edtaplasma"},
    {id: 22, text:"EDTA-Plasma bei Aufklärung II", type:"edtaplasma"},
    {id: 23, text:"EDTA-Plasma bei Aufklärung III", type:"edtaplasma"},
    {id: 24, text:"EDTA-Plasma bei Aufklärung IV", type:"edtaplasma"},

...
def seed_status_data(db: Session):
    ...
    if not db.query(Uebergeordnete_probenart_gewebe).first():
        ...
        seed_data = [
            ...
            Uebergeordnete_probenart_gewebe(uebergeordnete_probenart_text="Normal Empfänger der Leber"),
    ...
    if not db.query(Uebergeordnete_probenart_paraffin).first():
        ...
        seed_data = [
            ...
            Uebergeordnete_probenart_paraffin(uebergeordnete_probenart_text="Normal Empfänger der Leber"),

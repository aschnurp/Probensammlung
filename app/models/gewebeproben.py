...
class Gewebeproben(Base):
    ...
    uebergeordnete_probenart	= Column(TINYINT, ForeignKey("uebergeordnete_probenart_gewebe.id"), nullable=True)
    probenart = Column(TEXT)
    untergeordnete_probenart	= Column(TINYINT, ForeignKey("untergeordnete_probenart_gewebe.id"), nullable=True)
    abholer = Column(TEXT)
    uhrzeit = Column(TEXT)		

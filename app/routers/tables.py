...
#requestable tables
ALLOWED_TABLE_NAMES = {"patient", "serumproben", "gewebeproben", "urinproben", "paraffinproben", "probenabholer", "vorlaeufigeproben", "probeninformation", "probeninformation_ltx" ,"stuhlproben", "galleproben", "edtaplasmaproben"}

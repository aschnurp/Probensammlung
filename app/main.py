...
from .models import status, gewebeproben, probenabholer, serumproben, urinproben, patient, paraffinproben, uebergeordnete_probenart, untergeordnete_probenart_gewebe, untergeordnete_probenart_serum, untergeordnete_probenart_urin, probenquelle_urin
